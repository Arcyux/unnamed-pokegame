...
static const struct FormChange sArceusFormChangeTable[] = {
    ...
    {FORM_CHANGE_ITEM_HOLD,  SPECIES_ARCEUS_NORMAL,   ITEM_BLANK_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD,  SPECIES_ARCEUS_NORMAL,   ITEM_LEGEND_PLATE, ABILITY_MULTITYPE},
    ...
    {FORM_CHANGE_END_BATTLE, SPECIES_ARCEUS_NORMAL,   ITEM_LEGEND_PLATE},
    {FORM_CHANGE_TERMINATOR},
};
