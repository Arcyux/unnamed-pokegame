...
} static const sSaveSlotLayout[NUM_SECTORS_PER_SLOT] =
{
    ...
    SAVEBLOCK_CHUNK(struct SaveBlock2, 5),
    SAVEBLOCK_CHUNK(struct SaveBlock2, 6),
    SAVEBLOCK_CHUNK(struct SaveBlock1, 7), // SECTOR_ID_SAVEBLOCK1_END
...
{
    int i;
    for (i = SECTOR_ID_SAVEBLOCK1_START; i <= SECTOR_ID_SAVEBLOCK2_END; i++) {
