...
{
    { .data = 0, .size = 0x400, .tag = TAG_RESULTS_TEXT_WINDOW_LEFT },
    { .data = 0, .size = 0x400, .tag = TAG_RESULTS_TEXT_WINDOW_MIDLEFT },
    { .data = 0, .size = 0x400, .tag = TAG_RESULTS_TEXT_WINDOW_MIDRIGHT },
    { .data = 0, .size = 0x400, .tag = TAG_RESULTS_TEXT_WINDOW_RIGHT },
    { .data = 0, .size = 0x400, .tag = TAG_LINK_TEXT_WINDOW_LEFT },
    { .data = 0, .size = 0x400, .tag = TAG_LINK_TEXT_WINDOW_MIDLEFT },
    { .data = 0, .size = 0x400, .tag = TAG_LINK_TEXT_WINDOW_MIDRIGHT },
    { .data = 0, .size = 0x400, .tag = TAG_LINK_TEXT_WINDOW_RIGHT },
};
