...
#define VAR_TERRAIN                                      0x40F7 // Used to set terrain before battle
#define VAR_WILD_AI_FLAGS                                0x40F8 // Used to set wild AI flags. NOT usable with flags above (1 << 15)
#define VAR_LAST_REPEL_LURE_USED                         0x40F9 // Saves the last repel used
