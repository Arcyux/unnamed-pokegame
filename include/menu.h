...
#define MENU_TYPE_NOTVERY_EFF    (NUMBER_OF_MON_TYPES + 7)
#define MENU_TYPE_SUPER_EFF      (NUMBER_OF_MON_TYPES + 8)
#define MENU_TYPE_NO_EFF         (NUMBER_OF_MON_TYPES + 9)
#define MENU_TYPE_STAB           (NUMBER_OF_MON_TYPES + 10)
